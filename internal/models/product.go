...
type Product struct {
	...
	CategoryID    uuid.UUID       `gorm:"type:uuid;not null;index:idx_products_shop_category_id,priority:2" json:"categoryID"`
	...
	ShopID        uuid.UUID       `gorm:"type:uuid;not null;index:idx_products_shop_id;index:idx_products_shop_category_id,priority:1" json:"shopID"`
